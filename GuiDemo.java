...
public class GuiDemo extends JFrame{
	...
	public GuiDemo() {
		...
		drawPanel.getTextItem().setText(
				"Sorry is just another way of saying\n" +
				"      you are more important\n" +
				"          than my ego." 
			);
		drawPanel.getTextItem().setFontSize(40);
    ...
    private class ChooseBackgroundAction extends AbstractAction {
    	...
    	ChooseBackgroundAction(String text) {
    		...
    		g.fillRect(10, 0, 10, 32);
    		g.setColor(Color.GREEN);
    		g.fillRect(20, 10, 0, 32);
    		g.setColor(Color.BLUE);
    		g.fillRect(24, 0, 10, 32);
    		g.dispose();
